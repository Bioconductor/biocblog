...
::: {.column width="100%"}
![](images/group-photo.webp){group="gallery-intro"}
:::
::: {.column width="100%"}
![](images/bioc2024-numbers.png){group="gallery-intro"}
:::
:::
...
::: {.column width="33%"}
![](images/carpentries-jenny.jpg){group="gallery-carp" width="246" height="160" style="padding-right: 1px;"}
:::

::: {.column width="33%"}
![](images/carpentries-tim.jpg){group="gallery-carp" width="246" height="160" style="padding-right: 1px;"}
:::

::: {.column width="33%"}
![](images/carpentries-charlotte.jpg){group="gallery-carp" width="246" height="160"}
:::
:::
...
::: {style="text-align: center;"}
![Technical Core Overview](images/opening.jpg){width="70%"}
...
There was also a session to introduce the Bioconductor core team and boards to the community, where they gave an overview of who they are, what they do, and shared the annual call for new members to join the TAB and CAB and participate in Bioconductor decision-making. See details on the call [here](https://www.linkedin.com/posts/bioconductor_bioconductor-rstats-bioinformatics-activity-7221903619854381058-dFP6).
...
#introductions: A space for attendees to introduce themselves and get to know each other. #help-desk: For any questions or assistance needed during the conference. 
...
You can learn more about the Bioconductor awards and the stories behind the winners on the [Bioconductor website awards page](https://bioconductor.org/about/awards/). Below, you’ll find a gallery of the award certificates.

::: {#awards-gallery .columns}
::: {.column width="18.5%"}
![](images/awards-Freytag.png){group="awards-gallery" style="border: 1px solid #ccc; padding: 5px;"}
:::

::: {.column width="18.5%"}
![](images/awards-Moses.png){group="awards-gallery" style="border: 1px solid #ccc; padding: 5px;"}
:::

::: {.column width="18.5%"}
![](images/awards-Drnevich.png){group="awards-gallery" style="border: 1px solid #ccc; padding: 5px;"}
:::

::: {.column width="18.5%"}
![](images/awards-Morgan.png){group="awards-gallery" style="border: 1px solid #ccc; padding: 5px;"}
:::

::: {.column width="18.5%"}
![](images/awards-Calvo-Serra.png){group="awards-gallery" style="border: 1px solid #ccc; padding: 5px;"}
:::
:::
...
![](images/walking-tour.jpg){width="70%" fig-align="center"}
...
![](images/wes-vince.jpg){width="100%" group="gallery-wes"}

::: {#gallery-wes .columns}
::: {.column width="50%"}
![](images/wes-tim.jpg){group="gallery-wes"}
:::

::: {.column width="50%"}
![](images/wes-erica.jpg){group="gallery-wes"}
:::
:::
:::
