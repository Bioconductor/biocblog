...
There was also a session to introduce the Bioconductor core team and boards to the community, where they gave an overview of who they are, what they do, and shared the annual call for new members to join the [TAB](https://bioconductor.org/about/technical-advisory-board/) and [CAB](https://bioconductor.org/about/community-advisory-board/) and participate in Bioconductor decision-making. See details on the call [here](https://www.linkedin.com/posts/bioconductor_bioconductor-rstats-bioinformatics-activity-7221903619854381058-dFP6).
