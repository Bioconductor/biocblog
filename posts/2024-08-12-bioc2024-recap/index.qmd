...
![](images/maps-attendees.png){alt="Map showing the geographic distribution of BioC2024 attendees"}
...
::: {.column width="33%"}
![](images/carpentries-jenny.jpg){group="gallery-carp" width="246" height="160" style="padding-right: 1px;" alt="Jenny Drnevich teaching at the Carpentries workshop"}
:::

::: {.column width="33%"}
![](images/carpentries-tim.jpg){group="gallery-carp" width="246" height="160" style="padding-right: 1px;" alt="Tim Triche teaching at the Carpentries workshop"}
:::

::: {.column width="33%"}
![](images/carpentries-charlotte.jpg){group="gallery-carp" width="246" height="160" alt="Charlotte Hutchings teaching at the Carpentries workshop"}
:::
:::
...
::: {style="text-align: center;"}
![Technical Core Overview](images/opening.jpg){width="70%" alt="Hand-drawn diagram showing the technical core infrastructure of Bioconductor"}
...
![](images/workshops.png){width="70%" alt="Graphical representation of the number of workshops at BioC2024"}
