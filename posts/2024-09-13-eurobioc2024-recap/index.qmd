...
p <- ggplot(data = world) +
  ...
  annotate("text", x = 0, y = 93, label = paste("Total (", total_attendees, ")", sep = ""), size = 4, color = "black", hjust = 0.5)  # Add the total attendees text above the map
...
::: {.column width="20%"}
![](images/carpentries-laurent.jpg){group="gallery-carp" style="padding-right: 1px;" alt="Laurent teaching at the Introduction to R and Bioconductor workshop"}
:::
...
At EuroBioC2024, we took the opportunity to present the Bioconductor Athena Award in person to Bea’s mother, who lives in Spain. This award honors Bea’s significant contributions to the Bioconductor community and her enduring legacy. While the main awards ceremony, including the recognition of other community members, took place at BioC2024 in Grand Rapids in July, you can learn more about all the award winners by visiting the [Bioconductor awards page](https://bioconductor.org/about/awards) or reading the [BioC2024 blog post](https://blog.bioconductor.org/posts/2024-08-12-bioc2024-recap/).
