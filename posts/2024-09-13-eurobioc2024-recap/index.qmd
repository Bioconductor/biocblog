...
::: {.column width="33%"}
![](images/carpentries-oliver.jpg){group="gallery-carp" style="padding-right: 1px;" alt="Oliver Crook teaching at the Carpentries workshop"}
:::
...
-   Altuna Akalin, Group Leader, Berlin Institute for Medical Systems Biology, Max Delbrück Center for Molecular Medicine presented *"How AI will reshape life sciences research: Examples from the front lines"* 

-   Laura Symul, Junior professor, Stanford (USA) / UCLouvain (Belgium) presented *"	Multi-omics integration reveals host-microbiota interactions in the vaginal ecosystem."*

-   Florian Markowetz, Professor, the University of Cambridge presented *"All models are wrong and yours are useless"*.

-   Agne Antanaviciute, Junior Group Leader from the University of Oxford, presented *"In situ insights into intestinal interactions"*.
