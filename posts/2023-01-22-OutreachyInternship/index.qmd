...
[BSgenome](https://github.com/Bioconductor/BSgenome) is a package with many
uses, among which one of them is forging BSgenome data packages. BSgenome data
packages are very important because computational biologists use them to search
for particular DNA patterns in a genome, or to compute CG content and other
basic statistics, or to extract the DNA sequences for some regions of interest
like genes or CDS and translate them into amino acid sequences. However, the
current process of forging a BSgenome data package is quite long and confusing,
with a few redundant processes like creating a seed file before calling the
forgeBSgenomeDataPkg function on the seed file to create the package.
...
which was because I found these topics extra interesting. Because of this, I
found myself using R as my programming language of choice.
...
interest in. I applied to the Refactor the BSgenomeForge tools project because I
felt it had the skills required to make the best of this task.
...
My experience on the BSgenomeForge project has been incredible. Before starting
out, my knowledge of programming was mostly restricted to R, and even then I'd
only used it to carry out high level data analysis and machine learning tasks.

I feel like I have learnt a lot working on the 
[BSgenomeForge project](https://github.com/Bioconductor/BSgenomeForge), not just
about making packages, but how to structure my code, how to make it readable for 
other users,how to communicate with others, etc. Hervé certainly makes 
everything easier, by taking me through task workflows, and offering helpful 
pointers when I'm stuck.

I've had a chance to get involved on an interesting, highly collaborative open
source project, one that is used by so many people, and I have been given the
opportunity to create something that makes their work just a bit easier.
Everyday is an opportunity to learn something new, something I definitely do not
take for granted. Overall, my experience has been a turning point. You can read
more about it [here](https://kakopo.wordpress.com/), on my blog.
...
Bioconductor is made up of hundreds and thousands of software packages, and
fosters an equally diverse welcoming community. It has been an awesome
experience to interact with the community, contribute to the work being done
within the project and learn a lot! We encourage any open source enthusiasts, or
individuals with an interest in computational biology to contribute to the
project, and welcome themselves to a whole new adventure!
...
are encouraged to apply before February 6, 2023.

-   The application deadline for community members who are interested in 
submitting mentorship projects for the next cohort is February 24, 2023.
