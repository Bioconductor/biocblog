...
- The next Outreachy cohort starts on May 29, 2023, and prospective interns are encouraged to apply before February 6, 2023.

- The application deadline for community members who are interested in submitting mentorship projects for the next cohort is February 24, 2023. 
...
## Why we chose Bioconductor 
### Atuhurira Kirabo Kakopo
Hi, my name is Atuhurira Kirabo Kakopo, and I’m from Kampala, Uganda. I am on the cusp of graduating with a bachelor’s degree in Software Engineering. Academically, I thrived in my data science and artificial intelligence classes, which was because I found these topics extra interesting. Because of this, I found myself using R as my programming language of choice. 
When I started out in the Outreachy contribution period, I filtered out which projects I wanted to apply to based on my skill level. I was glad to find that on top of requiring R programming skills, Bioconductor was a project that focused on computational biology, a field that I didn’t study but had an interest in. I applied to the forgeBSgenome tools project because I felt it had the skills required to make the best of this task.
...
Working on the BSgenomeForge project, I feel like I have learnt a lot, not just about making packages, but how to structure my code, how to make it readable for other users, how to communicate with others, etc. Hervé certainly makes everything easier, by taking me through task workflows, and offering helpful pointers when I’m stuck. I’ve had a chance to get involved on an interesting, highly collaborative open source project, one that is used by so many people, and I have been given the opportunity to create something that makes their work just a bit easier. Everyday is an opportunity to learn something new, something I definitely do not take for granted. Overall, my experience has been a turning point. You can read more about it [here](https://kakopo.wordpress.com/), on my blog.
...
I look forward to continuing learning, contributing and helping make the Sweave2Rmd project a success. Here is the [link to my blog](https://dev.to/berylkanali) where I have been writing about my experience as an outreachy intern with bioconductor.
