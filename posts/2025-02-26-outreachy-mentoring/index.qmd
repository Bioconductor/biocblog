...
description: "Bioconductor has been participating in the Outreachy Internship program since 2022. In this post, our mentor shares her journey, detailing her experience mentoring on the Microbiome Study Curation project and open science projects in general."
author:
...
categories:
  - Outreachy
  - open science
image: "BugSigDB_team_meeting.png"
format:
  html:
    toc: true
lightbox: true
...
The recent [Outreachy coffee chat](https://www.youtube.com/watch?v=PiOm6nqzTVQ) made me think about my mentoring journey and all the bright minds I've had the privilege to work with and learn from. What started in 2020 as a simple involvement in open science initiatives (https://microbiomedigest.com/ and https://nsurp.org/) has blossomed into something far more meaningful than I could have imagined.
...
![](BugSigDB_team_meeting.png){width="70%" fig-align="center" group="gallery-intro" alt="BugSigDB team meeting"}

:::
*BugSigDB team meeting*
:::::

Twice a year, we welcome Outreachy applicants and select interns for paid 3-month internships. As an Outreachy mentor, nothing has been more gratifying than watching our community growth. Since 2022, our project has attracted more than hundred applicants each round, representing ten different countries across Africa, Asia, and South America. Each contributor enriches our community with their distinct perspectives and enthusiasm. It's always thrilling to see familiar faces return for another round of applications.
...
![](Svetlana’s_mentees_and_their_projects.png){width="80%" fig-align="center" group="gallery-intro" alt="Svetlana’s_mentees_and_their_projects"}
:::
...
![](x_post_screenshot.png){width="50%" fig-align="center" group="gallery-intro" alt="A proud-mentor moment when Victoria Poromon masterfully ran the Q&A at MVIF 34"}
:::
...
-   Contact me directly (www.linkedin.com/in/svetlana-ugarcina-perovic) with any questions or to express interest.
