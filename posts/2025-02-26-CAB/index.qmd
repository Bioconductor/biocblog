...
We also figured that many members of the Bioconductor community may not know we even exist, or what we get up to.
...
In my day-to-day research, I'm now working as part of a team on a large cohort study, wrangling (bulk) transcriptomics along with multiple additional 'omics layers (DNA, DNAme, Proteomics, Metabolomics, Lipidomics etc), in an ambitious collaboration between clinicians, Aboriginal Australians, public health experts and a team of bioinformaticians.
We're hoping to make some real gains in personalised medicine for the Australian Aboriginal community, who've experienced a much lower standard of medical care along with reduced access to care, and have paid a significant price with their health.
