...
description: "Written during CoFest at GBCC2025, this post shares training materials, introduces Galaxy tool wrapping, and previews what’s next for Bioconductor integration"
authors:
...
[Galaxy](https://usegalaxy.org/) is an open source, web-based platform designed to make complex computational analyses more accessible, reproducible, and transparent, no programming skills or specialised infrastructure required. It allows researchers to upload and analyse data, chain tools into workflows, and re-run analyses, all from their browser.

This is especially powerful for researchers without programming experience or access to high-performance computing. A great example is shared in this [GBCC2025 presentation](https://zenodo.org/records/15776929) by Carolina Santana from UEFS in Brazil, where students used Galaxy to analyse environmental microbiomes despite limited infrastructure and often sharing a single laptop. Tools like Galaxy help level the playing field.
...
It can be a modest effort but the potential impact is significant.
...
Also during CoFest, Gareth Price from Galaxy Australia proposed a simple but powerful addition: including a maintainer field in the Galaxy tool XML to link wrapped tools back to their Bioconductor maintainers ([see GitHub issue](https://github.com/galaxyproject/galaxy/issues/20583)). This could help surface hidden usage, support recognition, and potentially feed into metrics for grant reporting or community impact.
