...
![](1731708109822.jpg){width="80%" fig-align="center" group="gallery-intro" alt="SpatialData Workshop attendees"}
...
::: {.column width="50%"}
![](1731708107583.jpg){group="gallery-intro" alt="R Interoperability Team"}
:::
