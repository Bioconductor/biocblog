...
-   Copy Number Analysis
    ...
    -   [`SingleR`](https://bioconductor.org/packages/release/bioc/html/AneuFinder.html)
...
Bioconductor packages that made it in this `awesome_spatial_omics` lists are

-   [`nnSVG`](https://bioconductor.org/packages/release/bioc/html/nnSVG.html)

-   [`SpotClean`](https://bioconductor.org/packages/devel/bioc/html/SpotClean.html) in version 3.16 of Bioconductor
...
-   Single Cell Multi-Omics
     ...
     -   [`cardelino`](https://www.bioconductor.org/packages/devel/bioc/html/cardelino.html) in version 3.16 of Bioconductor
...
This blog post is made possible from an online Biocondutor meetup on 26 October 2022.
