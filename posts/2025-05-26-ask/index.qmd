...
![Figure 1.  Left panel: troff, eqn, and S code for processing by S REPORT.  Right panel: output including a table for which code is not shown.  From @becker1984s](combo.jpg)
