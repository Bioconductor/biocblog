...
author:
  - name: The rOpenSci Team
    url: http://ropensci.org/about
  - name: The Bioconductor Team
    url: https://www.bioconductor.org/about/core-team/
categories:
  - Bioconductor
  - R-universe
  - Infrastructure
date: 2026-04-08
image: "https://docs.r-universe.dev/img/bioc-pkg.png"
lightbox: true
---

<small><i>This article is cross-posted on [rOpenSci](https://ropensci.org/blog/) and [R-Consortium](https://r-consortium.org/blog/) blogs.</i></small>
...
Information about each package is available on `https://bioc.r-universe.dev/{pkgname}`, for example [https://bioc.r-universe.dev/DESeq2](https://bioc.r-universe.dev/DESeq2) shown below:

![screenshot of r-universe](https://docs.r-universe.dev/img/bioc-pkg.png)
