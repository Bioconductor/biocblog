...
3. **Create your post** 
   ...
   - Choose a date at least **one week after you plan to open the PR**. This gives time for review and scheduling before the post is published and promoted on Bioconductor social media channels. If multiple posts are submitted around the same time, we typically space them out by a day or so to improve visibility across channels.
